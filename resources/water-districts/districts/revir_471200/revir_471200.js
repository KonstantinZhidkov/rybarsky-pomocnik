...
revirGalleryImages.forEach(image => {
    image.addEventListener('click', function (event) {
        switch (event.target.id) {
            case '1':
                popupImage.setAttribute('src', '../../districts-images/revir_471200/471200_1-1.png');
                break;
            case '2':
                popupImage.setAttribute('src', '../../districts-images/revir_471200/471200_2-2.png');
                break;
            case '3':
                popupImage.setAttribute('src', '../../districts-images/revir_471200/471200_3-3.png');
                break;
            case '4':
                popupImage.setAttribute('src', '../../districts-images/revir_471200/471200_4-4.png');
                break;
            case '5':
                popupImage.setAttribute('src', '../../districts-images/revir_471200/471200_5-5.png');
                break;
            case '6':
                popupImage.setAttribute('src', '../../districts-images/revir_471200/471200_6-6.png');
                break;
        }
